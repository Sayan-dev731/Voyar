...
export const LensSelector = ({
    ...
    return (
        ...
        >
            <div
                className={`bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-lg mx-4 max-h-[90vh] overflow-hidden flex flex-col transition-all duration-300 ease-out border border-gray-100 dark:border-gray-800 ${isVisible
            ...
            >
                ...
                <div className="p-4 border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div className="flex-1 min-w-0">
                            <h4 className="text-sm font-medium text-gray-900 dark:text-white truncate">{productName}</h4>
                            <p className="text-xs text-gray-500 dark:text-gray-400">Select your lens preferences</p>
                        </div>
                        <button
                            onClick={handleClose}
                            ...
                            <div key={s.num} className="flex items-center">
                                <div className="flex flex-col items-center">
                                    <div
                                        className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-medium border-2 transition-all duration-300 ${step > s.num
                                            ...
                                            : step === s.num
                                                ? 'border-teal-600 text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-900/30 scale-110'
                                                : 'border-gray-300 dark:border-gray-600 text-gray-400 bg-white dark:bg-gray-800'
                                            }`}
                                    >
                                        {step > s.num ? <Check className="w-4 h-4" /> : s.num}
                                    </div>
                                    <span className={`text-[10px] mt-1 font-medium transition-colors duration-300 ${step >= s.num ? 'text-teal-700 dark:text-teal-400' : 'text-gray-400'
                                        }`}>
                                        {s.label}
                                    </span>
                                </div>
                                {idx < steps.length - 1 && (
                                    <div className="flex-1 mx-1 mt-[-16px]">
                                        <div className={`h-0.5 w-full transition-all duration-500 ${step > s.num ? 'bg-teal-600' : 'bg-gray-200 dark:bg-gray-700'
                                            }`} />
                                    </div>
                                )}
                            </div>
                ...
                <div className={`flex-1 overflow-y-auto p-6 transition-all duration-200 ease-out bg-white dark:bg-gray-900 ${getContentAnimation()}`}>
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-12 gap-3">
                            <div className="w-10 h-10 border-3 border-teal-600 border-t-transparent rounded-full animate-spin" />
                            <p className="text-sm text-gray-500 dark:text-gray-400">Loading lens options...</p>
                        </div>
                        ...
                        <div className="space-y-5 animate-fadeIn">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Enter Prescription</h3>
                            </div>

                            {/* Right Eye */}
                            <div className="bg-teal-50/50 dark:bg-teal-900/10 rounded-xl p-4 border border-teal-100 dark:border-teal-900/30">
                                <h4 className="text-sm font-medium text-teal-800 dark:text-teal-400 mb-3 flex items-center gap-2">
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    {['SPH', 'CYL', 'AXIS'].map((label) => (
                                        <div key={label}>
                                            ...
                                            <select
                                                className="w-full px-3 py-2.5 border border-gray-200 dark:border-gray-700/50 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:border-teal-500 transition-all bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    {['SPH', 'CYL', 'AXIS'].map((label) => (
                                        <div key={label}>
                                            <label className="block text-xs text-gray-500 dark:text-gray-400 mb-1.5">{label}</label>
                                            <select
                                                className="w-full px-3 py-2.5 border border-gray-200 dark:border-gray-700/50 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition-all bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                            ...
                            <Button
                                ...
                                className="w-full h-12 bg-gradient-to-r from-teal-600 to-teal-700 text-white hover:from-teal-700 hover:to-teal-800 shadow-lg shadow-teal-200 dark:shadow-teal-900/30 transition-all"
                            >
                        ...
                        <>
                            ...
                            {step === 1 && (
                                <div className="space-y-4 animate-fadeIn">
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Choose your Lens Type</h3>

                                    {/* Info banner */}
                                    <div className="bg-gradient-to-r from-blue-50 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-800/20 border-l-4 border-blue-500 p-3 rounded-r-xl">
                                        <div className="flex items-start gap-2">
                                            <div className="w-5 h-5 rounded-full bg-blue-500 flex items-center justify-center flex-shrink-0 mt-0.5">
                                                <span className="text-white text-xs font-bold">i</span>
                                            </div>
                                            <div>
                                                <p className="text-sm font-medium text-blue-800 dark:text-blue-300">Prepaid Payment Required</p>
                                                <p className="text-xs text-blue-600 dark:text-blue-400">Lenses require prepaid payment • Frames available with COD</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <button
                                            ...
                                            className={`w-full p-4 rounded-xl border-2 transition-all duration-200 text-left flex items-center justify-between group hover:shadow-md ${lensType === 'withPower'
                                                ...
                                                : 'border-gray-200 dark:border-gray-700 hover:border-teal-300 dark:hover:border-teal-700 dark:hover:bg-gray-800/50'
                                                }`}
                                        >
                                            <div className="flex items-center gap-3">
                                                <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl transition-transform group-hover:scale-110 ${lensType === 'withPower' ? 'bg-teal-100 dark:bg-teal-800/50' : 'bg-gray-100 dark:bg-gray-800'
                                                    }`}>
                                                    👓
                                                </div>
                                                <div>
                                                    <p className="font-medium text-gray-900 dark:text-white">With Power / Single Vision</p>
                                                    <p className="text-sm text-gray-500 dark:text-gray-400">Standard lens • Prepaid only</p>
                                                </div>
                                            </div>
                                            <ChevronRight className={`w-5 h-5 transition-all ${lensType === 'withPower' ? 'text-teal-600 dark:text-teal-400' : 'text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300'
                                                }`} />
                                        </button>
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl transition-transform group-hover:scale-110 ${lensType === 'zeroPower' ? 'bg-blue-100 dark:bg-blue-800/50' : 'bg-gray-100 dark:bg-gray-800'
                                                    }`}>
                                                    🔍
                                                </div>
                                                <div>
                                                    <p className="font-medium text-gray-900 dark:text-white">Zero Power</p>
                                                    <p className="text-sm text-gray-500 dark:text-gray-400">No prescription needed • Prepaid only</p>
                                                </div>
                                            </div>
                                            <ChevronRight className={`w-5 h-5 transition-all ${lensType === 'zeroPower' ? 'text-teal-600 dark:text-teal-400' : 'text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300'
                                                }`} />
                                        </button>
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl transition-transform group-hover:scale-110 ${lensType === 'frameOnly' ? 'bg-amber-100 dark:bg-amber-800/50' : 'bg-amber-50 dark:bg-amber-900/10'
                                                    }`}>
                                                    🛒
                                                </div>
                                                <div>
                                                    ...
                                                    <p className="text-sm text-gray-500 dark:text-gray-400">Just the frame, no lenses</p>
                                                </div>
                                            </div>
                                            <ChevronRight className={`w-5 h-5 transition-all ${lensType === 'frameOnly' ? 'text-amber-600 dark:text-amber-400' : 'text-amber-400 group-hover:text-amber-600 dark:group-hover:text-amber-300'
                                                }`} />
                                        </button>
                                    </div>
                                </div>
                            ...
                            {step === 2 && (
                                <div className="space-y-4 animate-fadeIn">
                                    <div className="flex items-center gap-3">
                                        <button onClick={handleBack} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700/50 rounded-full transition-colors">
                                            <ArrowLeft className="w-5 h-5 text-gray-600 dark:text-gray-400" />
                                        </button>
                                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Choose Power Type</h3>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        {Object.entries(lensSettings.powerTypes).map(([key, config], index) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className="flex items-center gap-3">
                                                        <div className={`w-12 h-12 rounded-full border-2 flex items-center justify-center text-xl transition-transform group-hover:scale-110 ${powerType === powerKey ? 'border-teal-500 bg-teal-100 dark:bg-teal-800/50' : 'border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800'
                                                            }`}>
                                                            {icons[powerKey]}
                                                        </div>
                                                        <div>
                                                            <p className="font-medium text-gray-900 dark:text-white flex items-center gap-2">
                                                                {config.label}
                                                                {isMostCommon && (
                                                                    <span className="text-xs bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-2 py-0.5 rounded-full">Popular</span>
                                                                )}
                                                            </p>
                                                            <p className="text-sm text-gray-500 dark:text-gray-400">Positive, Negative or Cylindrical</p>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-center gap-2">
                                                        <span className={`text-sm font-semibold ${powerType === powerKey ? 'text-teal-600 dark:text-teal-400' : 'text-gray-600 dark:text-gray-400'}`}>
                                                            ₹{config.price}
                                                        </span>
                                                        <ChevronRight className={`w-5 h-5 transition-all ${powerType === powerKey ? 'text-teal-600 dark:text-teal-400' : 'text-gray-400'
                                                            }`} />
                                                    </div>
                                                </button>
                                            )
                            ...
                            {step === 3 && (
                                <div className="space-y-4 animate-fadeIn">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Choose Lens Color</h3>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3 max-h-[350px] overflow-y-auto">
                                        {lensSettings.lensColors.map((color, index) => (
                                            ...
                                            >
                                                <div className="flex items-center gap-3">
                                                    <div
                                                        className={`w-10 h-10 rounded-full border-2 transition-transform group-hover:scale-110 ${lensColor === color.name ? 'border-teal-500 ring-2 ring-teal-200 dark:ring-teal-800' : 'border-gray-300 dark:border-gray-600'
                                                            }`}
                                                        style={{ backgroundColor: color.colorCode }}
                                                    />
                                                    <div className="flex-1 min-w-0">
                                                        <p className="font-medium text-gray-900 dark:text-white text-sm truncate">{color.name}</p>
                                                        {color.price > 0 && (
                                                            <p className="text-xs text-teal-600 dark:text-teal-400">+₹{color.price}</p>
                                                        )}
                                                    </div>
                            ...
                            {step === 4 && (
                                <div className="space-y-5 animate-fadeIn">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Add Your Power</h3>
                                    </div>

                                    {/* Power Range Selection */}
                                    <div className="space-y-2">
                                        <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Select Power Range</p>
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        {isFree ? (
                                                            <>
                                                                <span className="text-sm text-gray-400 dark:text-gray-500 line-through">₹399</span>
                                                                <span className="font-semibold text-green-600 dark:text-green-400">FREE</span>
                                                                <span className="text-xs bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-2 py-1 rounded">Save ₹399</span>
                                                            </>
                                                        ) : (
                                                            <span className="font-semibold text-gray-900 dark:text-white">₹{config.price}</span>
                                                        )}
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Add Your Prescription</p>
                                        <div className="space-y-2">
                                            <button
                                            ...
                                            >
                                                <Upload className={`w-5 h-5 ${prescriptionMethod === 'upload' ? 'text-teal-600 dark:text-teal-400' : 'text-gray-500 dark:text-gray-400'}`} />
                                            ...
                                            >
                                                <Edit3 className={`w-5 h-5 ${prescriptionMethod === 'manual' ? 'text-teal-600 dark:text-teal-400' : 'text-gray-500 dark:text-gray-400'}`} />
                                            ...
                                            >
                                                <Mail className={`w-5 h-5 ${prescriptionMethod === 'emailLater' ? 'text-teal-600 dark:text-teal-400' : 'text-gray-500 dark:text-gray-400'}`} />
                                                <span className="font-medium text-gray-900 dark:text-white">Email Later</span>
                ...
                {!showPrescriptionForm && (
                    <div className="p-4 border-t border-gray-100 dark:border-gray-800 bg-gray-50/80 dark:bg-gray-900/80 backdrop-blur">
                        {/* Price summary */}
                        {(lensType && lensType !== 'frameOnly') && (
                            <div className="flex items-center justify-between mb-3 text-sm">
                                <span className="text-gray-600 dark:text-gray-400">Lens Price</span>
                                <span className="font-semibold text-teal-600 dark:text-teal-400">₹{calculateLensPrice()}</span>
                            </div>
                        )}
