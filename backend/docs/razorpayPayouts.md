...
Handy Tips
It is mandatory to subscribe to the payout.failed event if you are using Payout APIs.
...
Watch Out!
UPI mode is not supported by payout.downtime webhooks.
...
Know about the Payouts Approval Payload.
